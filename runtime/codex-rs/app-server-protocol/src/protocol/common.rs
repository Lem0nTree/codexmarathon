...
server_notification_definitions! {
    ...
    /// Internal-only command consumed by the embedded Codex TUI. It releases
    /// the TUI-owned pending usage-limit continuation after Marathon has
    /// verified an identity-changing transition.
    CodexMarathonRecoveryRelease => "codexmarathon/recovery/release" (v2::CodexMarathonRecoveryReleaseNotification),
...
client_notification_definitions! {
    Initialized,
    /// Internal lifecycle observation for the embedded Marathon recovery seam.
    CodexMarathonRecoveryLifecycle(v2::CodexMarathonRecoveryLifecycleNotification),
    /// Internal acknowledgement for the embedded Marathon recovery seam.
    CodexMarathonRecoveryReleaseResult(v2::CodexMarathonRecoveryReleaseResultNotification),
}
