...
impl StatusSurfacePreviewItem {
    fn placeholder(self) -> &'static str {
        match self {
            ...
            StatusSurfacePreviewItem::Account => "user@example.com(Pro)",
            StatusSurfacePreviewItem::Marathon => "Marathon enabled",
            StatusSurfacePreviewItem::ManagedAccounts => "Accounts 2",
