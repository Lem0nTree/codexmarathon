...
impl ChatWidget {
    ...
    pub(super) fn new_with_op_target(
        ...
        let mut widget = Self {
            ...
            pending_usage_limit_resume_recovery_id: None,
            pending_usage_limit_resume_thread_id: None,
            pending_usage_limit_resume_turn_id: None,
            active_usage_limit_resume_recovery_id: None,
            active_usage_limit_resume_thread_id: None,
            active_usage_limit_resume_turn_id: None,
            active_usage_limit_resume_dispatch_turn_id: None,
            ...
            usage_limit_resume_auth_reloaded: false,
            marathon_recovery_controller_enabled: std::env::var_os("CODEXMARATHON_LISTEN")
