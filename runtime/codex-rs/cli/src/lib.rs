...
/// In-process CodexMarathon runtime integration points.  The CLI owns the
/// native Codex authorities while this module exposes the typed adapter seam;
/// no second Codex process or donor checkout is required.
pub mod codexmarathon {
    pub use codexmarathon_runtime::{
        CodexNativeRuntime, EmbeddedRuntime, NativeAuthConfig, NativeBackend, NativeCodexRuntime,
    };
}
